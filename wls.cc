...
int main(int argc, char** argv)
{
  ...
  G4Random::setTheSeed(seed); //--> messing with multi theading ? 

  G4int nThreads = 8;
  runManager->SetNumberOfThreads(nThreads);
  
  G4cout << "===== WLS is started with " <<  runManager->GetNumberOfThreads() << " threads =====" << G4endl;
  ...
  // Physics list
  G4VModularPhysicsList* physicsList = new FTFP_BERT; // Hadronic physics
